...
This project introduces a system that empowers users to control their digital footprint in physical spaces both verbally and through the website interface. Much like cookie consent banners on websites, which inform users and offer immediate choices about data collection, our system aims to establish an equivalent, intuitive consent mechanism for physical smart spaces.
...
[3] Marc Langheinrich. 2002. A Privacy Awareness System for Ubiquitous Computing Environments. In Proceedings of the 4th international conference on Ubiquitous Computing (UbiComp '02). Springer-Verlag, Berlin, Heidelberg, 237–245.

[4] Zhang, Han et al. “TEO: ephemeral ownership for IoT devices to provide granular data control.” Proceedings of the 20th Annual International Conference on Mobile Systems, Applications and Services (2022): n. pag.

[5] Eimaan Saqib, Shijing He, Junghyun Choy, Ruba Abu-Salma, Jose Such, Julia Bernd, and Mobin Javed. 2025. Bystander Privacy in Smart Homes: A Systematic Review of Concerns and Solutions. ACM Trans. Comput.-Hum. Interact. 32, 5, Article 43 (October 2025), 43 pages. https://doi.org/10.1145/3731755
